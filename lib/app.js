...
var queue, spotify, currentTrack, prePhoneVolume, phoneVolume = 65, lastTime, accessToken, accessTokenTimeout;
var playing = false;
...
function playTrack(track, attempt) {
    ...
    try {
        ...
        console.error(e);
        io.emit("error", "Can't play '" + track.name + "'")
        playTrack(queue.next(), attempt++);
    }
}
