            ...
            async.map(tracks, function (track, cb) {
                ...
                tracks.forEach(function (track) {
                    if (this._initializeTrack(track, source)) {
						if(/fit but you know it/.test(track.name.toLowerCase())) return; //Skip 'Fit but you know it'
        ...
        return new Promise(function (resolve, reject) {
            this.loadItem(track).then(function (track) {
                if (this._initializeTrack(track, source, true)) {
					if(/fit but you know it/.test(track.name.toLowerCase())) {  //Skip 'Fit but you know it'
						resolve(track);
						return; //Skip 'Fit but you know it'
					}
