...
$(function () {
    ...
    async.series([loadTemplates, loadPages], function () {
        ...
        socket.on("playQueue", function (_queue) {
            ...
            if (queue.tracks.length > 0) {
                getTracks(queue.tracks).then(function (tracks) {
                    ...
                    if ($queue.find("li").length > 0 && queue.tracks.length < 100) {
        ...
        $("body").on("click", ".show-search-btn", function () {
            ...
            handleURIAction.call(this, $(this).attr("data-action"), $(this).attr("data-uri"), $(this).parents("table").attr("data-uri"), e)
            return false;
            ...
            $(".track-popup").remove();
            handleURIAction.call(this, $(this).attr("data-double-action"), $(this).attr("data-uri"), $(this).parents("table").attr("data-uri"))
            return false;
            ...
            return false;
        }).on("click", "aside.play-queue .votes button.vote-btn", function () {
    ...
    $("body").on("contextmenu", selector, function (e) {
        ...
        Promise.all([cb.apply(this, arguments)]).then(function (items) {
            ...
            setTimeout(function () {
                var $ul = $menu.find("ul");
                $menu.css({
                    width: $ul.outerWidth() + 12,
                    height: $ul.outerHeight() + 20
                });
            }, 50);
        })
        return false;
