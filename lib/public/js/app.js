...
$(function () {
    ...
    async.series([loadTemplates, loadPages], function () {
        ...
        socket.on("playState", function (playing) {
            ...
            $("footer .play").toggleClass("mdi-av-play-arrow", !playing).toggleClass("mdi-av-pause", !!playing);
        ...
        $("body").on("click", ".current-playing-btn", function () {
        ...
        $("body").on("click", "[data-uri][data-action]", function (e) {
            $(".track-popup").remove();
