...
$(function () {
    ...
    async.series([loadTemplates, loadPages], function () {
        ...
        $("body").on("click", ".show-search-btn", function () {
            ...
            $("body").removeClass("show-mobile-controls");
        ...
        }).on("change keypress", ".search", _.debounce(function () {
            doSearch($(this).val());
        }, 1000)).on("click", ".close-search", function () {
            $(".search-content").removeClass("fadein")
            setTimeout(function () {
                $(".search-content").removeClass("show")
            }, 500)
            return false;
        }).on("click", ".search-tabs .search-tab", function () {
        ...
        }).on("mouseleave", ".track-popup", function (e) {
            var $to = $(e.toElement);
